...
(function(ns){
    ...
    ns.imagePathPNG = '../assets/png/';
    ns.imagePathSVG = '../assets/svg/';
            ...
            if( (typeof shortname === 'undefined') || (shortname === '') || (!(shortname in ns.emojioneList)) ) {
                ...
                if(ns.imageType === 'png') {
                    ...
                    if(ns.sprites) {
                        ...
                        replaceWith = '<div><object class="emojione" data="'+ns.imagePathSVG+unicode+'.svg'+ns.cacheBustParam+'" type="image/svg+xml" standby="'+alt+'">'+alt+'</object></div>';
                    }
                }
